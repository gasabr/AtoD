...
from atod.db.schemas import (create_abilities_scheme, create_heroes_scheme,
                             create_items_scheme)
...
def fill_abilities_specs(skills=None):
    ...
    # to use db model heroes table should be created first
    # to get list od heroes
